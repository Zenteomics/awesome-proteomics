...
- [MS Annika](https://github.com/hgb-bin-proteomics/MSAnnika) - Proteome Discoverer node for cleavable and non-cleavable XL-MS (MS2 and MS2–MS3); current v3.1.1 (Pastel listed 2.0) ([2.0 paper](https://doi.org/10.1021/acs.jproteome.3c00325), [3.0 paper](https://doi.org/10.1038/s42004-024-01386-x)). `[GUI]`
...
- [Cross-ID](https://www.hecklab.com/software/xlinkx/) - Windows visualization of XL-MS protein networks from XlinkX/.pdResult (or CSV); Pastel DisVis URL was wrong—DisVis is listed above for restraint validation ([paper](https://doi.org/10.1021/acs.jproteome.8b00725)). `[GUI]` 🪟
...
- [aLFQ](https://cran.r-project.org/package=aLFQ) - R/CRAN package for absolute LFQ abundance (TopN, iBAQ, APEX, NSAF, SCAMPI) with cross-validation error estimates (**1.3.5**; Pastel URL wrongly pointed at r-project.org) ([paper](https://doi.org/10.1093/bioinformatics/btu200); [GitHub](https://github.com/aLFQ/aLFQ)). `[Label-Free]` `[CLI]`
...
- [PIQMIe](https://github.com/arnikz/PIQMIe) - Self-hostable MaxQuant/Andromeda post-processor that links IDs/quant to UniProt in SQLite with web/REST summary grids (Zenodo **1.1.0**; Pastel biotools.nl URL parked) ([paper](https://doi.org/10.1093/nar/gku478)). `[GUI]` `[API]` 📦
...
- [DAVID](https://davidbioinformatics.nih.gov/) - NIH functional annotation/enrichment web suite for gene/protein lists (Knowledgebase **v2026_1**; Ortholog + modern UI; Pastel ncifcrf.gov URL superseded) ([2025](https://doi.org/10.1093/nar/gkag470); [2021](https://doi.org/10.1093/nar/gkac194)). `[GUI]` `[API]`
...
- [ExpressVis](https://omicsmining.ncpsb.org.cn/ExpressVis) - Interactive multi-omics expression explorer (DE, clustering, survival, KEGG/PPI modules); absorbs prior PPIExp/KeggExp (Pastel fgvis.com/PPIExp timed out; [Docker](https://github.com/OmicsMining/ExpressVis-docker)) ([NAR](https://doi.org/10.1093/nar/gkac399); [PPIExp](https://doi.org/10.1021/acs.jproteome.8b00713)). `[GUI]` 📦
...
- [PIA](https://github.com/medbioinf/pia) - Protein inference from one or multiple search engines (mzIdentML; CLI/Docker/Bioconda; ~**1.5.8**; Pastel `pia-core-library` superseded; KNIME deprecated) ([2015](https://doi.org/10.1021/acs.jproteome.5b00121); [2018](https://doi.org/10.1021/acs.jproteome.8b00723)). `[CLI]` 📦
...
- [ProForma](https://www.psidev.info/proforma) - HUPO-PSI human- and machine-readable notation for proteoforms/peptidoforms (mods, cross-links, isotopes; **2.0** / **2.1** final 2026-06); Pastel CTDP URL obsolete ([paper](https://doi.org/10.1021/acs.jproteome.1c00771)).
...
- [SignalP](https://services.healthtech.dtu.dk/services/SignalP-6.0/) - Predicts signal peptides and cleavage sites across domains of life (**6.0** protein-LM model; Pastel linked obsolete 5.0/cbs.dtu.dk) ([6.0](https://doi.org/10.1038/s41587-021-01156-3), [5.0](https://doi.org/10.1038/s41587-019-0036-z)). `[GUI]` `[CLI]`
...
- [SpotOn](https://alcazar.science.uu.nl/cgi/services/SPOTON/spoton/) - Ensemble ML web server classifying PPI interface residues as hot-spots vs null-spots (Bonvin/WeNMR; Pastel milou URL superseded; portal listing at [wenmr](https://wenmr.science.uu.nl/)) ([paper](https://doi.org/10.1038/s41598-017-08321-2)). `[GUI]`
...
- [InterPro](https://www.ebi.ac.uk/interpro/) - Classifies proteins into families and predicts domains and functional sites by integrating signatures from multiple member databases (archives retired PRINTS fingerprints; Pastel IP URL dead).
...
- [ProsperousPlus](http://prosperousplus.unimelb-biotools.cloud.edu.au/) - Platform to train/deploy protease-specific substrate cleavage predictors (PROSPER lineage; Pastel iProt-Sub Monash URL unresponsive) ([paper](https://doi.org/10.1093/bib/bbad372); [iProt-Sub](https://doi.org/10.1093/bib/bby028)). `[GUI]` `[CLI]`
- [Proteasix](https://proteasix.dev.finki.ukim.mk/) - Peptide-centric knowledgebase/predictor linking naturally occurring peptides to proteases (**2.0**; ~104k cleavage events; Pastel proteasix.org unresponsive) ([paper](https://doi.org/10.1002/pmic.201200493)). `[GUI]` `[API]`
...
- [APID](http://apid.dep.usal.es) - Integrated experimentally validated PPI interactomes across >1,100 organisms with binary vs indirect evidence filters (Pastel cicblade URL dead; hosting can be intermittent) ([NAR](https://doi.org/10.1093/nar/gkw363); [2019](https://doi.org/10.1093/database/baz005)). `[GUI]`
...
- [HuRI](https://www.interactome-atlas.org/) - Systematic binary human reference interactome from Y2H (~53k PPIs in HuRI; HI-union aggregates CCSB screens; Pastel Baderlab URL unresponsive) ([paper](https://doi.org/10.1038/s41586-020-2188-x)). `[GUI]`
...
- [Mechnetor](https://mechnetor.russelllab.org/) - Mechanistic PPI/domain/motif networks for proteins, variants, and PTMs (Russell-lab successor to Mechismo; Pastel Mechismo URL unresponsive) ([paper](https://doi.org/10.1093/nar/gkab399); [Mechismo](https://doi.org/10.1093/nar/gku1094)). `[GUI]`
...
- [Proteome PheWAS (EpiGraphDB pQTL)](https://epigraphdb.org/pqtl/) - Browser of phenome-wide MR/colocalization of plasma pQTLs vs ~225 traits (~989 proteins; Pastel `www.epigraphdb.org` URL) ([paper](https://doi.org/10.1038/s41588-020-0682-6); [scripts](https://github.com/MRCIEU/epigraphdb-pqtl)). `[GUI]` `[API]`
...
- [Colorectal Cancer Atlas](https://www.coloncanceratlas.org/) - Integrated CRC genomic/proteomic atlas with reanalyzed label-free MS expression (~62k protein IDs / >8.3M MS/MS across tissues and cell lines; Pastel colonatlas.org domain hijacked) ([paper](https://doi.org/10.1093/nar/gkv1097)). `[GUI]`
...
- [EVpedia](https://evpedia.info/) - Integrated EV proteome/transcriptome/lipidome DB across prokaryotes and eukaryotes with enrichment/network tools (Pastel POSTECH URL 503; last update 2023-07) ([JEV](https://doi.org/10.3402/jev.v2i0.20384); [Bioinformatics](https://doi.org/10.1093/bioinformatics/btu741)). `[GUI]`
...
- [CRAPome / RePRINT](https://reprint-apms.org/) - Contaminant repository of negative-control AP-MS data (**CRAPome V2.0**) plus REPRINT scoring/network tools; Pastel crapome.org URL redirects here ([paper](https://doi.org/10.1038/nmeth.2557)). `[GUI]`
...
- [ProLuCID](http://fields.scripps.edu/downloads.php) - Classic Yates Lab SEQUEST-like search (J Proteomics 2015); Pastel academic download page no longer serves binaries (faculty redirect). Still used via commercial IP2; metaproteomics derivative is [Blazmass / ComPIL](#metaproteomics) ([paper](https://doi.org/10.1016/j.jprot.2015.07.001)). `[DDA]` `[CLI]`

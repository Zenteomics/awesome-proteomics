...
- [A beginner's guide to mass spectrometry-based proteomics](https://doi.org/10.1042/bio20200057) - Open-access introduction by Sinha and Mann (2020, The Biochemist) to mass spectrometer components, sample preparation, and quantification strategies.
...
- [A researcher's guide to mass spectrometry-based proteomics](https://doi.org/10.1002/pmic.201600113) - Instrument primer by Savaryn, Toby, and Kelleher (2016, Proteomics) explaining LC-MS ion physics and analyzer components (ion optics, traps, quadrupoles, Orbitrap) for readers without a physics background.
...
- [RforProteomics](https://bioconductor.org/packages/release/data/experiment/html/RforProteomics.html) - Bioconductor ExperimentData companion (~1.50) reproducing Gatto & Christoforou BBA proteomics-in-R tutorials and discovering related Bioconductor MS packages ([paper](https://doi.org/10.1016/j.bbapap.2013.04.032)).
...
- [EMBL-EBI Proteomics Bioinformatics](https://www.ebi.ac.uk/training/events/proteomics-bioinformatics-2027) - Recurring face-to-face EMBL-EBI course on search engines, quantification, data repositories, and downstream analysis.
...
- [Proteomics Academy](https://www.proteomics-academy.org/) - Free educational materials and curated links to community Q&A platforms maintained by EuBIC-MS and the EuPA education committee.
...
- [CompOmics Lectures](https://www.youtube.com/playlist?list=PLXxp6nsBenSX_W8DiOocKJ0laNauYNdYl) - YouTube playlist from the CompOmics group ("Mass spectrometry basics") covering MS fundamentals with a proteomics focus.
...
- [Introduction to Proteomics: Tools for the New Biology](https://link.springer.com/book/10.1007/978-1-59259-130-5) - Liebler (2002) textbook on protein and peptide separation, mass spectrometry, and data analysis for biologists; [2nd ed. (2007)](https://link.springer.com/book/10.1007/978-1-58829-896-6) also on Springer.
...
- [ABRF Proteomics Research Group (PRG; formerly sPRG/iPRG)](https://abrf.org/research-groups/proteomics-research-group-prg/) - ABRF volunteer groups that ran collaborative inter-laboratory studies producing reference standards, benchmark datasets, and method comparisons; studies archived through ~2018, groups sunset 2025.
- [ProteoBench](https://proteobench.readthedocs.io/en/stable/) - Community-curated platform for comparing proteomics data analysis workflows (DDA/DIA LFQ, de novo, low-input DIA) with public and private benchmark runs via its [web app](https://proteobench.cubimed.rub.de/) ([preprint](https://doi.org/10.64898/2025.12.09.692895)). `[GUI]` 🧪
...
- [Mass-spectrometry-based proteomics: from single cells to clinical applications](https://doi.org/10.1038/s41586-025-08584-0) - Guo, Steen, and Mann (2025, Nature) review of advances in sample preparation, instrumentation, data acquisition, and single-cell and clinical applications.

### Milestone Papers

- [Proteoform: a single term describing protein complexity](https://doi.org/10.1038/nmeth.2369) - Smith, Kelleher, et al. (2013, Nature Methods) proposes "proteoform" as the term for the molecular forms of a protein.
...
- [Mass-spectrometry-based draft of the human proteome](https://doi.org/10.1038/nature13319) - Wilhelm et al. (2014, Nature) draft human proteome assembled from large-scale datasets and released through [ProteomicsDB](https://www.proteomicsdb.org/).
...
- [Protein Prospector](https://prospector.ucsf.edu/) - Web suite for MS-based sequence database searching with utilities (MS-Product, MS-Digest, MS-Isotope) for calculating fragment ions, in silico digests, and isotope patterns (desktop v6.9.0). 💰
...
- [XlinkX](https://www.hecklab.com/software/xlinkx/) - Thermo Proteome Discoverer node for cleavable/non-cleavable XL-MS (MS2–MS3 workflows; current XlinkX 3.3 / PD 3.3 SP1) from the Heck lab ([paper](https://doi.org/10.1038/ncomms15473)). `[GUI]` 💰 🪟
...
- [PeptideVisualizer](https://github.com/kolocode/Peptide-Visualizer) - Open-source PROTOMAP analysis tool that builds MaxQuant peptographs with UniProt features and a mismatch factor to flag proteolytic events ([paper](https://doi.org/10.1021/acs.jproteome.5c01209)). `[GUI]`
- [ProteoAutoNet](https://github.com/guomics-lab/ProteoAutoNet) - Robotics-assisted co-fractionation MS (CF-MS) workflow with XGBoost co-elution PPI prediction and data augmentation ([paper](https://doi.org/10.1038/s41467-026-68686-9)). `[CLI]`
...
- [HiTMaP](https://github.com/MASHUOA/HiTMaP) - R toolbox (v1.0.1) for FDR-controlled peptide mass fingerprinting annotation and spatial visualization of high-resolution MALDI-MSI proteomics ([Docker](https://hub.docker.com/r/mashuoa/hitmap)) ([paper](https://doi.org/10.1038/s41467-021-23461-w)). `[CLI]` `[API]` 📦
...
- [VoltRon](https://github.com/BIMSBbioinfo/VoltRon) - R spatial-omics platform (v0.3.0) with OpenCV image registration across multi-resolution assays; supports Visium/Xenium/CosMx/GeoMx and custom IMC via formVoltRon ([preprint](https://doi.org/10.1101/2023.12.15.571667)). `[CLI]` `[API]` 🧪
...
- [PeptideCutter](https://web.expasy.org/peptide_cutter/) - ExPASy web tool that predicts protease and chemical cleavage sites in a protein sequence. `[GUI]`
...
- [DigestedProteinDB](https://github.com/jankod/DigestedProteinDB) - Mass-indexed in silico peptide digest database (Java/RocksDB) with web and REST search by mass or sequence; NCBI taxonomy filters apply at build time ([portal](https://digestedproteindb.pbf.hr/)). `[CLI]` `[API]`
...
- [FragPipe](https://fragpipe.nesvilab.org/) - Graphical pipeline built on MSFragger for DDA, DIA, and labeling workflows (v24.0). `[DDA]` `[DIA]` `[TMT]` `[GUI]` `[CLI]`
...
- [Scaffold DDA](https://www.proteomesoftware.com/products/scaffold-dda) - Commercial DDA validation and labeled/label-free quantification platform (Sage/MSFragger search; TMT/iTRAQ/SILAC; v7.1.0; successor to Scaffold 5/Q+S) ([paper](https://doi.org/10.1002/pmic.200900437)). `[DDA]` `[TMT]` `[Label-Free]` `[GUI]` 💰
...
- [Novor (novor.cloud)](https://novor.cloud/) - Cloud de novo sequencing and protein ID (RAW/mzML/timsTOF; Rapid Novor); free for academic non-commercial use per Terms of Service ([paper](https://doi.org/10.1007/s13361-015-1204-0)). `[DDA]` `[GUI]`
...
- [TopRepo](https://github.com/toppic-suite/toprepo) - Top-down spectral repository (>12M MS/MS spectra from 12 species; curated library >5M annotated) for pan-dataset analysis, library search, and DL spectral prediction ([preprint](https://doi.org/10.64898/2026.02.20.707032)). 🧪
...
- [VisioProt-MS](https://masstools.ipbs.fr/mstools/visioprot-ms/) - Shiny/web 2D maps of intact-protein / top-down LC-MS (MW vs RT) with MS/MS ID overlays; **v2.4** supports PD 3.0 / ProSightPD 4.2 ([GitHub](https://github.com/mlocardpaulet/VisioProt-MS); [paper](https://doi.org/10.1093/bioinformatics/bty680)). `[GUI]`
...
- [EncyclopeDIA](https://bitbucket.org/searleb/encyclopedia) - Library search engine for DIA using chromatogram and DDA-based spectral libraries; Walnut implements PECAN-style library-free FASTA search; also ships [Scribe](#identification) for predicted-library DDA search (≥2.12.30). `[DIA]` `[GUI]` `[CLI]`
...
- [Carafe2](https://github.com/Noble-Lab/Carafe) - Deep learning tool that builds experiment-specific in silico spectral libraries by fine-tuning RT, fragment intensity, and (for timsTOF) ion mobility models on DIA data, including native Bruker .d ([preprint](https://doi.org/10.64898/2026.03.27.714846)). `[DIA]` `[GUI]` `[CLI]` 🧪
...
- [DIAlignR](https://github.com/Roestlab/DIAlignR) - Retention time alignment across DIA, SWATH, PRM, and SRM runs for consistent quantification (formerly Bioconductor; removed from Bioc 3.20+) ([paper](https://doi.org/10.1074/mcp.TIR118.001132)). `[DIA]` `[CLI]`
...
- [MSPLIT-DIA](https://massive.ucsd.edu/) - Untargeted spectral-library matching for multiplexed DIA spectra (up to ~10 peptides per spectrum) via the CCMS [ProteoSAFe](https://proteomics.ucsd.edu/ProteoSAFe/) / MassIVE workflow ([paper](https://doi.org/10.1038/nmeth.3655)). `[DIA]` `[CLI]`

### Targeted / SRM / PRM

- [Skyline](https://skyline.ms/project/home/software/Skyline/begin.view) - Open-source environment for building and analyzing SRM, PRM, targeted, and DIA assays. `[Targeted]` `[DIA]` `[GUI]` 🪟 ([benchmark](https://doi.org/10.1038/nbt.3685))
...
- [DIGEST](https://digest.raylab.iiitd.edu.in/) - Web tool for MRM transition and unique-ion-signature design from protein sequences with PTM and interference checks ([preprint](https://doi.org/10.1101/2023.11.27.568790)). `[Targeted]` `[GUI]` 🧪
- [PeptideRanger](https://github.com/rr-2/PeptideRanger) - R package that ranks proteotypic peptides for synthetic/targeted assays via a random-forest detectability model (pre-trained models with optional retraining) ([paper](https://doi.org/10.1021/acs.jproteome.2c00538)). `[Targeted]` `[CLI]` `[API]`
...
- [AlacatDesigner](https://bitbucket.org/mjr129/alacat) - Designs quantotypic peptides and QconCAT/ALACAT concatamer standards for absolute MS protein quantitation (desktop/CLI/web interface) ([paper](https://doi.org/10.1021/acs.jproteome.2c00608)). `[Targeted]` `[GUI]` `[CLI]` `[API]`
- [Panorama](https://panoramaweb.org/) - Web repository and dashboard for targeted proteomics data built on Skyline documents. `[Targeted]` `[GUI]` `[API]`
...
- [MRMAssayDB](http://mrmassaydb2.proteomicscentre.com/) - Integrated targeted-assay knowledge base aggregating CPTAC, SRMAtlas, Panorama, PeptideAtlas/PASSEL, and PeptideTracker (~1.1M assays / ~61k proteins / 146 organisms; AlphaFold mapping); HTTPS redirect has an expired certificate as of 2026-07 ([paper](https://doi.org/10.1080/14789450.2025.2557023), [PeptideTracker](https://doi.org/10.1002/pmic.201600210)). `[Targeted]` `[GUI]`
...
- [PhosphoSitePlus](https://www.phosphosite.org/) - Curated knowledge base of experimentally observed phosphorylation, acetylation, ubiquitination, and methylation sites in human, mouse, and rat; free web access for academic and commercial browsing (bulk/downloads require CST license). `[GUI]`
- [EPSD 2.0](http://epsd.biocuckoo.cn/) - Eukaryotic phosphorylation site database (~2.77M experimental p-sites in 223 species) with functional annotations and phosphopeptide provenance ([paper](https://doi.org/10.1093/gpbjnl/qzaf057)). `[GUI]`
...
- [Phosphopedia](https://phosphopedia.gs.washington.edu/PhosphoproteomicsAssay/) - Human phosphosite/phosphopeptide atlas (~109k sites) with plug-and-play PRM assay design for targeted phosphoproteomics ([paper](https://doi.org/10.1038/nmeth.3811)). `[GUI]`
...
- [LuciPHOr2](http://luciphor2.sourceforge.net/) - Target-decoy site localization for generic modifications with false localization rate estimation from tandem MS data; legacy SourceForge distribution (see [onsite](https://github.com/bigbio/onsite) for maintained successor). `[CLI]`
...
- [DAPPLE 2](https://saphire.usask.ca/saphire/dapple2/) - Homology-based prediction of 20 PTM types in a target organism from experimental sites in other species (BLAST/RAPSearch2; SAPHIRE-hosted; connection may be slow) ([paper](https://doi.org/10.1021/acs.jproteome.6b00304)). `[GUI]`
...
- [MoMo (MEME Suite)](https://meme-suite.org/meme/doc/momo.html) - Discovers sequence motifs associated with modification sites, reimplementing motif-x and MoDL with a web server and source code. `[CLI]` `[GUI]`
- [KSEA App](https://github.com/casecpb/KSEA) - Shiny web app for Kinase-Substrate Enrichment Analysis to infer changes in kinase activity from phosphoproteomics data; non-commercial use only. `[GUI]`
- [KEA3](https://maayanlab.cloud/kea3/) - Web tool inferring upstream kinases whose putative substrates are enriched in a query protein or phosphoprotein list. `[GUI]` `[API]`
...
- [pGlyco3](https://github.com/pFindStudio/pGlyco3) - Search engine for intact N- and O-glycopeptides and modified glycans with separate peptide and glycan FDR control (free license via [i.pfind.org](https://i.pfind.org/)). `[GUI]` 🪟
...
- [GlycoDiveR](https://github.com/riley-research/GlycoDiveR) - Modular R framework that imports FragPipe, Byonic, pGlyco, Perseus, and MSstats glycoproteomics outputs into 22 publication-ready visualizations ([paper](https://doi.org/10.1021/acsmeasuresciau.6c00077)). `[CLI]` `[API]`
...
- [pGlycoQuant](https://github.com/Power-Quant/pGlycoQuant) - Quantification tool for intact glycopeptides that works with pGlyco3 and other search results. `[GUI]` 🪟
...
- [GlyTouCan](https://glytoucan.org/) - International glycan structure repository that assigns globally unique accession numbers to registered glycans. `[GUI]`
- [GPnotebook (Glycoprotein-Notebook)](https://www.biomarkercenter.org/gpnotebook) - Pan-cancer CPTAC intact glycopeptide MS resource and analysis toolkit (~433k N-linked intact glycopeptides across 10 tumor types) with Python notebooks ([paper](https://doi.org/10.1016/j.mcpro.2025.101089)). `[GUI]` `[CLI]`
...
- [GlyConnect](https://glyconnect.expasy.org/) - Database of glycosylation sites, glycan structures, and associated proteins on the SIB ExPASy portal. `[GUI]`
- [UniCarbKB](https://unicarbkb-glycostore.gitbook.io/data) - Curated glycoproteomics knowledgebase of experimentally determined glycan structures linked to glycoproteins and sites (`unicarbkb.org` domain hijacked; data/SPARQL docs on GitBook) ([paper](https://doi.org/10.1093/nar/gkt1128)). `[GUI]`
...
- [GlyGen](https://www.glygen.org/) - Integrated knowledge base unifying glycan, glycoprotein, and glycosylation data from multiple sources. `[GUI]`
- [GlyCosmos](https://glycosmos.org/) - Glycoscience portal (v4.6.0) integrating glycan structures, glycogenes, glycoproteins, pathways, and related repositories ([v4 paper](https://doi.org/10.1007/s00216-024-05692-0)). `[GUI]`
- [GlyComb](https://glycomb.glycosmos.org/) - FAIR glycoconjugate repository that assigns stable IDs to glycopeptide/glycoprotein + GlyTouCan glycan sets and links GlyCosmos / GlyTouCan / GlycoPOST ([paper](https://doi.org/10.1016/j.jbc.2023.105624)). `[GUI]`
- [GlycoEnzDB](https://www.virtualglycome.org/glycoenzdb/) - Database of ~403 human glycosylation enzymes (GlycoEnzOnto) with pathway maps, expression, and CRISPR aids ([paper](https://doi.org/10.1093/glycob/cwaf074)). `[GUI]`
...
- [PTMiner](http://fugroup.amss.ac.cn/software/ptminer/ptminer.html) - Filters, localizes, and Unimod-annotates modifications from open or closed searches (pFind, MSFragger, MaxQuant, and others) with mass-shift FDR and Bayesian site assignment ([paper](https://doi.org/10.1074/mcp.RA118.000812)). `[DDA]` `[GUI]` 🪟
- [ReCom](https://github.com/CNIC-Proteomics/ReCom) - Comet-based semi-supervised ultra-tolerant open search that rescores modified-peptide candidates using Unimod delta-mass priors (ReCom v1.0.0) ([paper](https://doi.org/10.1016/j.jprot.2023.104968)). `[DDA]` `[CLI]`
...
- [FLEXIQuant-LF](https://github.com/SteenOmicsLab/FLEXIQuantLF) - RANSAC-based label-free quantification of peptide modification extent from unmodified-peptide intensities without prior knowledge of the PTM type ([paper](https://doi.org/10.7554/eLife.58783)). `[CLI]` `[GUI]`
...
- [hmSEEKER](https://bitbucket.org/2020-methylproteome-project/hmseeker/src/master/) - MaxQuant post-processor that finds heavy-methyl SILAC (hmSILAC) light/heavy methyl-peptide doublets (v2.0 ML used for ProMetheusDB; legacy `EMassi/silac_etc` repo removed) ([paper](https://doi.org/10.1002/pmic.201800300), [ProMetheusDB](https://doi.org/10.1016/j.mcpro.2022.100243)). `[CLI]`
...
- [UbiBrowser](http://ubibrowser.bio-it.cn/ubibrowser_v3/) - Known and predicted E3 ligase / DUB–substrate interactions across 39 eukaryotes (~4k/1k curated plus ~2.2M scored predictions; live portal titled v2) ([paper](https://doi.org/10.1093/nar/gkab962)). `[GUI]` `[API]`
...
- [SwissPalm](https://swisspalm.org/) - Curated S-palmitoylation knowledge base integrating MS palmitoyl-proteomes and literature sites across species, with proteome comparison and ortholog views (SwissPalm 2; SSL chain may trigger browser warnings) ([paper](https://doi.org/10.1007/978-1-4939-9532-5_16)). `[GUI]`
...
- [dbPTM](https://biomics.lab.nycu.edu.tw/dbPTM/) - Integrated database of experimentally verified and predicted PTM sites with functional and structural annotation. `[GUI]`
...
- [FAT-PTM](https://fat-ptm.tinnguyen-lab.com/) - Arabidopsis MS PTM database (~49k sites across eight modification types) with protein networks, quantitative phosphosite views, and pathway mapping ([paper](https://doi.org/10.1111/tpj.14372)). `[GUI]`
...
- [VPTMdb](http://vptmdb.com:8787/VPTMdb/) - Viral and infected-host PTM database (~1.2k viral sites across eight modification types plus host PTMs) with VPTMpre phosphorylation prediction (port 8787 required; slow to load) ([paper](https://doi.org/10.1093/bib/bbaa251)). `[GUI]`
...
- [O-GlcNAcAtlas](https://oglcnac.org/atlas/) - Curated database of experimentally identified protein O-GlcNAc sites with site-specific quantification across species and conditions (v4.0) ([paper](https://doi.org/10.1016/j.jmb.2025.169033)). `[GUI]`
- [StrucPTM](https://github.com/HanyangBISLab/StrucPTM) - Database of PTM residues validated at atom level in PDB structures, with UniProt mapping and homolog-based conformational comparison ([paper](https://doi.org/10.1093/bioinformatics/btag190)). `[GUI]`
- [iPTMnet](https://research.bioinformatics.udel.edu/iptmnet/) - Bioinformatics resource integrating PTM sites, modifying enzymes, and substrate relationships for systems biology. `[GUI]` `[API]`
- [Unimod](https://www.unimod.org/modifications_list.php) - Reference of protein modifications and their mass shifts for mass spectrometry, maintained with the HUPO-PSI (use **Login as Guest**; [downloads](https://www.unimod.org/downloads.html) for `unimod.xml`). `[GUI]`
...
- [PSCS](https://pscs.xods.org/) - No-code web platform for designing, running, and publishing shareable single-cell omics analysis pipelines with data and interactive results; hosted portal returned HTTP 502 as of 2026-08 (paper + [GitHub API](https://github.com/xomicsdatascience/pscs_api) still live) ([paper](https://doi.org/10.1021/acs.jproteome.5c00178)). `[GUI]`
...
- [SCP resources (Slavov Lab)](https://scp.slavovlab.net/) - Community hub for single-cell proteomics methods, protocols, datasets, and reporting guidelines. `[GUI]`
...
- [falcon](https://github.com/bittremieuxlab/falcon) - Large-scale MS/MS spectrum clustering via feature hashing, approximate nearest neighbors, and DBSCAN (PyPI `falcon-ms` 0.1.3) ([paper](https://doi.org/10.1002/rcm.9153)). `[DDA]` `[CLI]`
...
- [PeptideForest](https://github.com/peptideforest/peptideForest) - Semisupervised random-forest rescoring that integrates PSMs from multiple DDA search engines (pyiohat-compatible multi-engine inputs) ([paper](https://doi.org/10.1021/acs.jproteome.4c00686)). `[DDA]` `[CLI]` `[API]`
...
- [FlashLFQ](https://github.com/smith-chem-wisc/FlashLFQ) - Label-free quantification engine with match-between-runs, usable standalone or within MetaMorpheus (v2.1.4). `[Label-Free]` `[CLI]` `[GUI]`
...
- [StPeter](http://tools.proteomecenter.org/wiki/index.php?title=Software:StPeter) - Normalized Spectral Index (SIn) label-free quantification from MS/MS identifications within the Trans-Proteomic Pipeline (StPeter2Matrix for multi-sample matrices) ([paper](https://doi.org/10.1021/acs.jproteome.7b00786)). `[Label-Free]` `[CLI]`
...
- [directLFQ](https://github.com/MannLabs/directlfq) - Label-free protein quantification using a ratio-based algorithm that scales linearly to very large sample cohorts. `[Label-Free]` `[CLI]` `[GUI]` `[API]`
...
- [Triqler](https://github.com/statisticalbiotechnology/triqler) - Probabilistic model that propagates identification and quantification error into protein-level fold changes. `[Label-Free]` `[CLI]`
...
- [aLFQ](https://cran.r-project.org/package=aLFQ) - R/CRAN package for absolute LFQ abundance (TopN, iBAQ, APEX, NSAF, SCAMPI) with cross-validation error estimates (**1.3.6**; CRAN archived 2026-05) ([paper](https://doi.org/10.1093/bioinformatics/btu200); [GitHub](https://github.com/aLFQ/aLFQ)). `[Label-Free]` `[CLI]`
...
- [Mass Dynamics](https://www.massdynamics.com/) - Commercial cloud workspace for proteomics QC, differential analysis, enrichment, and collaborative sharing (modular templates/API; linked preprint describes MD 2.0) ([preprint](https://doi.org/10.1101/2022.12.12.517480)). `[GUI]` `[API]` 💰
...
- [RepExplore](https://lcsb-repexplore.uni.lu/repexplore/) - LCSB web tool that propagates technical-replicate variance into differential abundance / PCA / ranking for proteomics and metabolomics tables (hosted site intermittently unreachable) ([paper](https://doi.org/10.1093/bioinformatics/btv127)). `[GUI]` `[API]`
...
- [POMAShiny](https://webapps.nutrimetabolomics.com/POMAShiny) - Shiny/Docker workflow for MS metabolomics and proteomics preprocess, EDA, and stats via Bioconductor [POMA](https://bioconductor.org/packages/POMA/) (~v1.22.0; hosted site intermittently unreachable) ([paper](https://doi.org/10.1371/journal.pcbi.1009148)). `[GUI]` 📦
...
- [protti](https://cran.r-project.org/package=protti) - R package for quality control and analysis of bottom-up and LiP-MS data, working with output from Spectronaut, MaxQuant, and Proteome Discoverer (v1.0.0) ([paper](https://doi.org/10.1093/bioadv/vbab041)). `[CLI]` `[API]`
...
- [Autoprot](https://github.com/ag-warscheid/autoprot) - Python package for quantitative proteomics downstream analysis that bridges R statistics and interactive Plotly visualization in Jupyter ([preprint](https://doi.org/10.1101/2024.01.18.571429)). `[API]` 🧪
...
- [einprot](https://github.com/fmicompbio/einprot) - R package of reproducible Markdown workflows for MaxQuant/FragPipe LFQ and Proteome Discoverer TMT (QC, limma/proDA DE, interactive reports; v0.10.2) ([paper](https://doi.org/10.21105/joss.05750)). `[CLI]` `[API]`
...
- [prolfquapp](https://github.com/prolfqua/prolfquapp) - Command-line interface to [prolfqua](#statistical-analysis) for differential expression and QC reports from DIA-NN, MaxQuant, FragPipe, and Spectronaut outputs ([paper](https://doi.org/10.1021/acs.jproteome.4c00911)). `[CLI]` 📦
...
- [ProteoMill](https://proteomill.com/) - Shiny portal for proteomics QC, differential expression, and interactive STRING/Reactome network enrichment (hosted site intermittently unreachable; [GitHub](https://github.com/martinry/ProteoMill); last push ~2022) ([paper](https://doi.org/10.1093/bioinformatics/btab373)). `[GUI]`
...
- [clusterProfiler](https://github.com/YuLab-SMU/clusterProfiler) - Enrichment and GSEA tool with visualization for interpreting protein and gene lists across many ontologies and species. `[CLI]` `[API]`
...
- [PEANUT](https://peanut.cs.tau.ac.il/) - Web tool for pathway enrichment that propagates preranked gene/protein scores through PPI networks before enrichment testing (hosted site intermittently unreachable) ([paper](https://doi.org/10.1093/bioinformatics/btaf410)). `[GUI]`
- [pQTLtools](https://github.com/jinghuazhao/pQTLtools) - R toolkit for protein QTL / GWAS analysis (Manhattan/QQ, cis–trans classification, colocalization, MR) with companion panels for pQTL summary statistics. `[CLI]` `[API]`
...
- [MsXpertSuite](http://www.msxpertsuite.org/) - Free suite for MS data visualization/mining (**mineXpert2**, Debian bullseye) and polymer chemistry modelling (**massXpert2**); HTTPS cert broken (use HTTP); mzML/mzXML/MGF and native Bruker timsTOF ([MineXpert](https://doi.org/10.1021/acs.jproteome.9b00099), [MineXpert2](https://doi.org/10.1021/jasms.0c00402)). `[GUI]` 🐧 🪟 🍎
...
- [ComplexHeatmap](https://github.com/jokergoo/ComplexHeatmap) - R/Bioconductor package for generating annotated heatmaps, applied to proteomics expression matrices. `[CLI]` `[API]`
...
- [iceLogo](https://iomics.ugent.be/icelogoserver/) - CompOmics web/SOAP tool for probability-based consensus sequence logos of peptides vs proteome- or protocol-aware backgrounds (hosted HTTPS may timeout; HTTP fallback) ([Nat Methods](https://doi.org/10.1038/nmeth1109-786); [NAR server](https://doi.org/10.1093/nar/gkv385)). `[GUI]` `[API]`
...
- [ExpressVis](https://omicsmining.ncpsb.org.cn/ExpressVis) - Interactive multi-omics expression explorer (DE, clustering, survival, KEGG/PPI modules) ([Docker](https://github.com/OmicsMining/ExpressVis-docker)) ([NAR](https://doi.org/10.1093/nar/gkac399); [PPIExp](https://doi.org/10.1021/acs.jproteome.8b00713)). `[GUI]` 📦
...
- [MassDash](https://github.com/Roestlab/massdash) - Web/Python dashboard for interactive DIA chromatogram and ion-mobility visualization across OpenSWATH, DIA-NN, and dreamDIA results (v0.1.1; [demo](https://massdash.streamlit.app) may redirect to Streamlit login) ([paper](https://doi.org/10.1021/acs.jproteome.4c00026)). `[DIA]` `[GUI]` `[API]` 📦
...
- [RawTools](https://github.com/kevinkovalchik/RawTools) - Cross-platform QC/parse/quant of Thermo Orbitrap `.raw` DDA files (local RawToolsViz; ~2.0.7; legacy hosted Shiny at rawtoolsqcdv.bcgsc.ca down; RawQuant successor) ([paper](https://doi.org/10.1021/acs.jproteome.8b00721)). `[CLI]` `[GUI]` 🐧 🪟 🍎
- [rawrr](https://bioconductor.org/packages/rawrr) - R package for reading Thermo raw files directly for diagnostics and QC. `[API]`
- [PTXQC](https://github.com/cbielow/PTXQC) - R package generating HTML/PDF QC reports from MaxQuant txt or mzTab (CRAN **1.1.6**; GitHub **v1.1.5.1**) ([paper](https://doi.org/10.1021/acs.jproteome.5b00780)). `[CLI]`
...
- [rawDiag](https://github.com/fgcz/rawDiag) - R package producing diagnostic plots from raw files to support rational LC-MS method optimization. `[CLI]` `[GUI]`
...
- [HowDirty](https://github.com/DavidGZ1/HowDirty) - R package (v1.0.0) that turns Skyline MS1 contaminant features into interactive HTML reports of PEG, detergent, and other LC-MS sample contaminants ([paper](https://doi.org/10.1002/pmic.202300134)). `[CLI]` `[GUI]`
...
- [FragPipe](https://fragpipe.nesvilab.org/) - See [Discovery Proteomics](#discovery-proteomics). GUI pipeline integrating MSFragger, IonQuant, and Philosopher (v24.0); MSFragger requires academic registration (commercial via Fragmatics).
- [OpenMS](https://www.openms.de/) - Open-source C++/Python framework with composable tools for building MS workflows (v3.5.0). `[CLI]` `[GUI]` `[API]` 🐧 🪟 🍎
...
- [multiplierz](https://github.com/BlaisProteomics/multiplierz) - Python mzAPI ecosystem for native vendor MS access plus search/quant scripting; mzDesktop GUI and mzStudio browser companions (~2.2.2; Windows-primary vendor DLL access) ([paper](https://doi.org/10.1002/pmic.201700091)). `[CLI]` `[API]` `[GUI]` 🪟
- [psims](https://github.com/mobiusklein/psims) - Declarative Python writer for HUPO-PSI mzML and mzIdentML (and mzMLb) with controlled-vocabulary handling (PyPI `psims` 1.4.0) ([paper](https://doi.org/10.1074/mcp.RP118.001070)). `[API]`
...
- [PIA](https://github.com/medbioinf/pia) - Protein inference from one or multiple search engines (mzIdentML; CLI/Docker/Bioconda; ~**1.5.9**; KNIME deprecated) ([2015](https://doi.org/10.1021/acs.jproteome.5b00121); [2018](https://doi.org/10.1021/acs.jproteome.8b00723)). `[CLI]` 📦
...
- [ProtPipe](https://github.com/NIH-CARD/ProtPipe) - Singularity/CLI pipeline for DIA-NN, Spectronaut, and FragPipe proteomics/peptidomics (QC, DE, enrichment, AP-MS, immunopeptidomics); hosted Streamlit demo may be unreachable; active R rewrite is [ProtPipe2](https://github.com/NIH-CARD/ProtPipe2) ([paper](https://doi.org/10.1093/gpbjnl/qzae083)). `[CLI]` `[GUI]` 📦

### Cloud & HPC

- [nf-core/quantms](https://github.com/bigbio/quantms) - Cloud-ready Nextflow DDA LFQ/TMT pipeline (v1.10.0; ecosystem at [quantms.org](https://quantms.org/)); DIA moved to [quantmsdiann](https://github.com/bigbio/quantmsdiann); nf-core mirror archived at 1.2.0 ([paper](https://doi.org/10.1038/s41592-024-02343-1)). `[DDA]` `[TMT]` `[Label-Free]` `[CLI]` 📦
- [Frag'n'Flow](https://github.com/ronalabrcns/FragNFlow) - Nextflow pipeline wrapping the FragPipe ecosystem for large-scale quantitative proteomics on HPC, cloud, and clusters, validated across label-free DDA, DIA, and TMT datasets (v2.0.0; MSFragger requires academic registration; [paper](https://doi.org/10.1186/s12859-025-06305-y)). `[DDA]` `[DIA]` `[TMT]` `[Label-Free]` `[CLI]` 📦
...
- [PANOPLY](https://github.com/broadinstitute/PANOPLY) - Broad/CPTAC Terra cloud platform for automated proteogenomic analysis (association, NMF, CNA–protein, GSEA/ssGSEA; **v1.4** production workspaces) ([paper](https://doi.org/10.1038/s41592-021-01176-6)). `[CLI]` `[GUI]` 📦
- [MS-PyCloud](https://github.com/huizhanglab-jhu/ms-pycloud) - Cloud/local GUI pipeline for proteomic and glycoproteomic LC-MS/MS (search, FDR, protein inference, protein/glyco/PTM quant; v3.1.0-alpha Electron release) ([paper](https://doi.org/10.1021/acs.analchem.3c01497)). `[GUI]` `[CLI]`
- [CloudProteoAnalyzer](https://github.com/Biocomputing-Research-Group/CloudProteoAnalyzer) - HPC/cloud SaaS-style proteomics ID/quant wrapping Sipros Ensemble and ProRata; prefer GitHub (hosted site sipros.oscer.ou.edu unreachable with expired TLS as of 2026-07) ([paper](https://doi.org/10.1093/bioadv/vbae024)). `[GUI]`
...
- [snakemake-ms-proteomics](https://github.com/MPUSP/snakemake-ms-proteomics) - Snakemake pipeline for label-free DDA built on FragPipe and MSstats with automated quality control (MSFragger requires academic registration). `[DDA]` `[Label-Free]` `[CLI]`
...
- [Sage](https://github.com/lazear/sage) - See [Identification](#identification). Cloud-ready Rust engine that streams data from S3/GCS/Azure for large-scale searches.
...
- [Prosit](https://www.proteomicsdb.org/prosit/) - Deep learning models for fragment intensity and retention time prediction, used for spectral libraries and rescoring (browser web UI; programmatic access via [Koina](#foundation-models--protein-language-models-plms)). `[GUI]`
- [OmicLearn](https://github.com/MannLabs/OmicLearn) - Browser Streamlit app for transparent ML biomarker discovery from proteomics/omics matrices (classifiers, feature importance; v1.4; Streamlit demo may require login) ([paper](https://doi.org/10.1021/acs.jproteome.2c00473)). `[GUI]`
- [DeepLC](https://github.com/compomics/DeepLC) - Retention time prediction for peptides, including modified peptides not seen during training. `[CLI]` `[GUI]` `[API]`
- [Casanovo](https://github.com/Noble-Lab/casanovo) - Transformer de novo peptide sequencer (and DB-search scoring) from MS/MS spectra; v5.2.1 adds timsTOF .d support ([paper](https://doi.org/10.1038/s41467-024-49731-x)). `[CLI]`
...
- [Ionmob](https://github.com/theGreatHerrLebert/ionmob) - Python framework for peptide collisional cross-section (CCS) prediction from timsTOF data, with pretrained models (PyPI 0.2.2) ([paper](https://doi.org/10.1093/bioinformatics/btad486)). `[CLI]` `[API]`
...
- [ESM (Evolutionary Scale Modeling)](https://github.com/Biohub/esm) - Protein language models (ESM-2 and ESMFold, plus the newer ESM3 and ESMC) for sequence representation, structure-aware embeddings, and structure prediction; the original facebookresearch/esm repository is now archived. `[API]`
...
- [PTM-Mamba](https://github.com/programmablebio/ptm-mamba) - PTM-aware protein language model with bidirectional gated Mamba blocks fused to ESM-2 embeddings (weights CC BY-NC-ND 4.0) ([paper](https://doi.org/10.1038/s41592-025-02656-9)). `[CLI]`
...
- [ColabFold](https://github.com/sokrypton/ColabFold) - Protein structure prediction that accelerates AlphaFold2 by replacing the MSA step with MMseqs2 search (not applicable to ESMFold); runnable in Google Colab or on the command line. `[CLI]` `[GUI]` `[API]`
...
- [ProForma](https://www.psidev.info/proforma) - HUPO-PSI human- and machine-readable notation for proteoforms/peptidoforms (mods, cross-links, isotopes; **2.1** final 2026-06; **2.0** final 2022-02) ([paper](https://doi.org/10.1021/acs.jproteome.1c00771)).
...
- [π-MSNet](https://msnet.ncpsb.org.cn/) - Billion-scale AI-ready proteomics data portal (~1.66B spectra / 501M PSMs) with QPX Parquet access and MSNetLoader for model training and benchmarking ([preprint](https://doi.org/10.64898/2026.04.13.718149)). `[API]` `[GUI]` 🧪
...
- [ProteoWizard](https://proteowizard.sourceforge.io/) - Libraries and tools (including msconvert) for converting and processing raw vendor data; native vendor RAW access is Windows-first (Docker/Wine elsewhere). `[CLI]` `[GUI]` 🪟
...
- [usiGrabber](https://github.com/usiGrabber/usiGrabber) - Scalable framework that parses PRIDE mzIdentML into a USI-indexed database and downloads/export spectra for ML-ready proteomics datasets ([preprint](https://doi.org/10.64898/2026.03.15.711873)). `[CLI]` 🧪
...
- [GeneCards](https://www.genecards.org/) - Aggregates gene-centric genomic, transcriptomic, proteomic, and disease information for human genes from many integrated sources (commercial API and bulk licensing via LifeMap Sciences). 💰
- [MoonProt](http://www.moonlightingproteins.org/) - Manually curated database of proteins with multiple independent functions (**4.0**; ~700 entries; HTTP-only) ([paper](https://doi.org/10.1016/j.jmb.2026.169840)). `[GUI]`
- [MoonDB](http://moondb.hb.univ-amu.fr/) - Predicted extreme multifunctional proteins (MoonGO) plus curated moonlighting entries across human and four model species (**2.0**; HTTP-only) ([paper](https://doi.org/10.1093/nar/gky1039)). `[GUI]`
...
- [neXtProt](https://www.expasy.org/archives/nextprot) - Integrated human protein sequence, expression, interaction, PTM, and variant data; reached end of life in 2024 after 14 years, with its data and tools archived on Expasy and still downloadable.
...
- [OrthoDB](https://www.orthodb.org/) - Hierarchical catalog of orthologs across eukaryotes, prokaryotes, and viruses with evolutionary/functional annotations (**v12.2**; ~165M genes; custom inference via [OrthoLoger](https://orthologer.ezlab.org/); API rate-limited to ~1 req/s with download caps) ([paper](https://doi.org/10.1093/nar/gkae987)). `[GUI]` `[API]` `[CLI]`
...
- [PSORTb](https://www.psort.org/psortb/) - Prokaryotic-only protein subcellular localization predictor (v3.0.3; web, standalone, Docker); companion [PSORTdb 4.0](https://db.psort.org/) for precomputed/experimental localizations ([paper](https://doi.org/10.1093/bioinformatics/btq249)). `[GUI]` `[CLI]` 📦
- [SignalP](https://services.healthtech.dtu.dk/services/SignalP-6.0/) - Predicts signal peptides and cleavage sites across domains of life (**6.0** protein-LM model; academic CLI is email-gated; web batch ≤5k seq; commercial use requires DTU license) ([6.0](https://doi.org/10.1038/s41587-021-01156-3), [5.0](https://doi.org/10.1038/s41587-019-0036-z)). `[GUI]` `[CLI]`
...
- [Proteome-pI 2.0](https://isoelectricpointdb2.mimuw.edu.pl/) - Precomputed proteome-scale isoelectric points (~61M sequences / 20k proteomes) with in-silico protease digests for bottom-up planning ([paper](https://doi.org/10.1093/nar/gkab944)). `[GUI]`
...
- [VEuPathDB](https://veupathdb.org/) - Eukaryotic pathogen, vector, and host multi-omics portal (merger of EuPathDB-family sites including PlasmoDB, ToxoDB, and FungiDB) with proteomes and search strategies; NIAID funding lapsed Sep 2024 and a voluntary subscription model began Mar 2025 ([paper](https://doi.org/10.1093/nar/gkad1003)). `[GUI]`
...
- [AlphaFold Protein Structure Database](https://alphafold.ebi.ac.uk/) - Provides over 241 million predicted protein structures from AlphaFold (AFDB v6; FAQ cites ~263M as of 2026), developed by Google DeepMind and EMBL-EBI under a CC-BY-4.0 licence (AlphaFold 3 structures not included).
...
- [EncoMPASS](https://encompass.ninds.nih.gov/) - Relates integral membrane protein PDB structures by sequence, fold, and quaternary/internal symmetry relative to the membrane (v2.1.2).
...
- [Membranome](https://biomembhub.org/membranome/) - Structural database of single-pass (bitopic) transmembrane proteins across six organisms, with membrane-positioned AlphaFold models, TM helix/dimer models, and complexes (v3.0; `membranome.org` redirects here) ([paper](https://doi.org/10.1002/pro.4318)). `[GUI]`
...
- [PEP-SiteFinder](https://bioserv.rpbs.univ-paris-diderot.fr/services/PEP-SiteFinder/) - Blind identification of peptide-binding patches on a protein surface via PEP-FOLD conformations and rigid docking (RPBS; legacy server with size/queue limits) ([paper](https://doi.org/10.1093/nar/gku404)). `[GUI]`
- [HawkDock](https://cadd.zju.edu.cn/hawkdock/) - Protein–protein docking and interface analysis (**2**; GeoDock flexible docking, VD-MM/GBSA, mutation module; receptor size limits apply) ([2.0](https://doi.org/10.1093/nar/gkaf379); [1.0](https://doi.org/10.1093/nar/gkz397)). `[GUI]`
- [StructureMapper](https://github.com/nurmians/StructureMapper) - Maps sequence points-of-interest (PTMs, cleavage sites, etc.) onto homologous PDB structures with ASA/DSSP/interface annotations (online `structuremapper.uta.fi` unreachable as of 2026; code frozen ~2018) ([paper](https://doi.org/10.1093/bioinformatics/bty086)). `[CLI]` `[GUI]`
- [SpotOn](https://alcazar.science.uu.nl/cgi/services/SPOTON/spoton/) - Ensemble ML web server classifying PPI interface residues as hot-spots vs null-spots (Bonvin/WeNMR; registration required; portal listing at [wenmr](https://wenmr.science.uu.nl/)) ([paper](https://doi.org/10.1038/s41598-017-08321-2)). `[GUI]`
- [MIEC-SVM](http://wanglab.ucsd.edu/MIEC-SVM/) - Structure-based pipeline for protein–peptide/ligand specificity via MM/GBSA interaction-energy components + SVM (pipeline **v1.1**; HTTP-only; frozen ~2015) ([paper](https://doi.org/10.1093/bioinformatics/btv666)). `[CLI]`
- [InterPred](http://bioinfo.ifm.liu.se/inter/interpred/) - Pipeline/web server to predict and model PPIs from sequence via structural comparison and docking (wallnerlab.org mirror flaky) ([paper](https://doi.org/10.1002/prot.25280)). `[GUI]` `[CLI]`
...
- [wwPDB](https://www.wwpdb.org/) - Consortium that manages the single global Protein Data Bank archive and OneDep deposition system across RCSB PDB, PDBe, PDBj, BMRB, and EMDB (deposition requires validated experimental metadata via OneDep).

### Families, Domains & Ontologies

- [ELM (Eukaryotic Linear Motif resource)](http://elm.eu.org/) - Annotates and predicts short linear motifs that mediate protein interactions and regulation in eukaryotic proteins (HTTP-only; HTTPS times out).
- [SLiMSuite](https://github.com/slimsuite/SLiMSuite) - Edwards-lab open-source SLiM discovery/analysis toolkit (SLiMFinder etc.; **v1.12.0**, 2024; [blog](http://slimsuite.blogspot.com/)) complementary to ELM/SLiMSuite; UNSW web servers out of action as of 2025—use GitHub/self-host ([method](https://doi.org/10.1371/journal.pone.0000967); [server](https://doi.org/10.1093/nar/gkq440)). `[CLI]`
...
- [Pfam](https://www.ebi.ac.uk/interpro/entry/pfam/) - Provides protein families represented by multiple sequence alignments and hidden Markov models, now hosted within InterPro (`pfam.xfam.org` is a redirect shell; HMM/seed downloads remain on Pfam FTP).
- [PROSITE](https://prosite.expasy.org/) - Documents protein domains, families, and functional sites with patterns and profiles, complemented by ProRule annotation rules (CC BY-NC-ND; commercial license required; ScanProsite limited to 10 seq / 16 MB).
...
- [SUPERFAMILY](https://supfam.org/) - Annotates protein domains at the SCOP superfamily level with HMM libraries across sequenced genomes; also contributed as an InterPro member database (free registration required for HMM download).

### Enzymes & Peptidases

- [BRENDA](https://www.brenda-enzymes.org/) - Provides functional enzyme data including kinetics, substrates, reactions, and organisms organized by EC classification; free under a CC-BY-4.0 licence (SOAP API requires registration with ≤1 req/s; SPARQL endpoint also available).
...
- [MEROPS](https://www.ebi.ac.uk/merops/) - Classifies peptidases (proteases), their inhibitors, and substrates into a structure-based hierarchy of families and clans (volunteer EBI maintenance; last release **12.5**, Sep 2023).
- [ProsperousPlus](http://prosperousplus.unimelb-biotools.cloud.edu.au/) - Platform to train/deploy protease-specific substrate cleavage predictors (PROSPER lineage; HTTP-only) ([paper](https://doi.org/10.1093/bib/bbad372); [iProt-Sub](https://doi.org/10.1093/bib/bby028)). `[GUI]` `[CLI]`
- [Proteasix](https://proteasix.dev.finki.ukim.mk/) - Peptide-centric knowledgebase/predictor linking naturally occurring peptides to proteases (**2.0**; ~104k cleavage events; programmatic access via MCP, not REST) ([paper](https://doi.org/10.1002/pmic.201200493)). `[GUI]` `[API]`
...
- [APID](http://apid.dep.usal.es) - Integrated experimentally validated PPI interactomes across >1,100 organisms with binary vs indirect evidence filters (HTTP-only) ([NAR](https://doi.org/10.1093/nar/gkw363); [2019](https://doi.org/10.1093/database/baz005)). `[GUI]`
...
- [CORUM](https://mips.helmholtz-muenchen.de/corum/) - Manually curated mammalian protein complexes (**5.2**/**5.3**; ~7,969 complexes) with subunit, function, disease, and drug–complex annotations ([paper](https://doi.org/10.1093/nar/gkae1033)).
...
- [HuRI](https://interactome-atlas.org/) - Systematic binary human reference interactome from Y2H (~53k PPIs in HuRI; HI-union aggregates CCSB screens; avoid `www` subdomain — SSL cert mismatch) ([paper](https://doi.org/10.1038/s41586-020-2188-x)). `[GUI]`
...
- [MINT](https://mint.bio.uniroma2.it/) - Stores experimentally verified protein-protein interactions curated from the literature, integrated with IntAct under the IMEx consortium (primary host intermittently unreachable; data available via IntAct/IMEx).
...
- [STRING](https://string-db.org/) - Known and predicted protein associations (functional, physical, and regulatory/directional networks; NAR 2025 paper cites v12.5 while live site reports v12.0 as of 2026) with enrichment and clustering; API rate-limited to ≥1 s/call ([paper](https://doi.org/10.1093/nar/gkae1113)).
- [Tabloid Proteome](https://iomics.ugent.be/tabloidproteome) - Protein functional associations inferred from co-occurrence across public MS proteomics datasets (CompOmics/ELIXIR Belgium; MoDPA PTM-site extension; `/api` endpoint is a stub only) ([paper](https://doi.org/10.1093/nar/gkx930)). `[GUI]`
- [PICKLE](http://www.pickle.gr/) - Human and mouse direct-PPI meta-database integrating IntAct/BioGRID/HPRD with ontology-based normalization (**3.3**; HTTP-only) ([3.0](https://doi.org/10.1093/bioinformatics/btaa1070); [2.0](https://doi.org/10.1371/journal.pone.0186039)). `[GUI]`
- [PEPPI](https://zhanggroup.org/PEPPI/) - Consensus PPI predictor combining multimeric threading, sequence homology, STRING association, and ML (web server outage reported as of 2026; [standalone](https://github.com/ewbell94/PEPPI) for proteome-scale) ([paper](https://doi.org/10.1016/j.jmb.2022.167530)). `[GUI]` `[CLI]`
...
- [PSINDB](https://psindb.itk.ppke.hu/) - Curated human postsynaptic binary PPI database with binding regions, structural features, and disease annotations (**v1.04**; host unreachable as of 2026) ([paper](https://doi.org/10.1093/database/baac007)). `[GUI]`
...
- [PPIDomainMiner](https://ppidm.loria.fr/) - Inferred Pfam–Pfam domain–domain interactions (~84k Gold/Silver/Bronze) from multiple PPI sources ([paper](https://doi.org/10.1371/journal.pcbi.1008844); [Zenodo](https://doi.org/10.5281/zenodo.4880347)).
- [Proteo3Dnet](https://bioserv.rpbs.univ-paris-diderot.fr/services/Proteo3Dnet/) - Structures MS interactomics hit lists via PDB interologs, ELM SLiMs, and BioGRID/IntAct into explorable interaction graphs (≤400 proteins per submission) ([NAR](https://doi.org/10.1093/nar/gkab332); [method](https://doi.org/10.1021/acs.jproteome.0c00066)). `[GUI]`
...
- [Yeast Interactome (Mann Lab)](http://yeast-interactome.biochem.mpg.de:3838/interactome/) - Interactive portal for the AE-MS Saccharomyces cerevisiae interactome (~3.9k proteins / ~31k interactions from ~4.2k GFP pull-downs; portal down as of 2026) ([paper](https://doi.org/10.1038/s41586-023-06739-5)). `[GUI]`
...
- [ChEMBL](https://www.ebi.ac.uk/chembl/) - Provides manually curated bioactivity data linking drug-like molecules to protein targets under a CC-BY-SA licence (public REST API available).
- [DBSAV](http://prodata.swmed.edu/DBSAV/) - Reports DeepSAV deleteriousness scores for human single-amino-acid variants and gene-level GTS tolerance scores with sequence and structure context (HTTP-only).
- [ProteoCast](https://github.com/abakarovaMarina/ProteoCast) - GEMME-based proteome-wide missense variant effect predictor that classifies substitutions as neutral, mild, or impactful and flags mutation-sensitive sites (primary paths are Docker and [web server](https://proteocast.ijm.fr); GitHub for source) ([paper](https://doi.org/10.1038/s41467-026-72140-1)). `[CLI]` `[GUI]`
...
- [OMIM](https://www.omim.org/) - Catalogs human genes and genetic disorders with curated gene-to-phenotype relationships from the biomedical literature (bulk downloads and REST API require registration at data.omim.org).
- [Open Targets Platform](https://platform.opentargets.org/) - Integrates genetic, omics, and literature evidence to score and prioritize therapeutic targets for diseases (public GraphQL API available).
...
- [PMADS](https://pmads-db.org/) - Database of curated and proteomics-inferred PTM–drug–disease associations linking modification sites to drug sensitivity contexts (`pmads.org` is NXDOMAIN; origin returned HTTP 522 as of 2026) ([paper](https://doi.org/10.1093/nar/gkaf1033)).
- [decryptM](https://www.proteomicsdb.org/decryptM) - ProteomicsDB JS SPA resource of dose- and time-resolved MS PTM responses to cancer drugs (~1.8M curves; phospho/ub/acetyl) with analysis pipeline at [kusterlab/decryptM](https://github.com/kusterlab/decryptM) ([paper](https://doi.org/10.1126/science.ade3925)). `[GUI]`
- [ProTargetMiner](http://protargetminer.genexplain.com/) - Shiny library of anticancer-compound proteome signatures (55 compounds in A549; PLS-DA target deconvolution; PRIDE PXD009775) ([paper](https://doi.org/10.1038/s41467-019-13582-8)). `[GUI]`
...
- [AHP DB (Aqueous Humor Proteomics)](https://ahp.augusta.edu/) - Reference LC-MS/MS proteome of human aqueous humor (~307 samples / ~1,683 proteins) with clinical metadata ([paper](https://doi.org/10.1093/database/baae001)). `[GUI]`
- [Alzheimer’s Disease Proteome Database](http://www.dementia-proteomes-project.manchester.ac.uk/Proteome/Search) - Searchable Bayesian browser of iTRAQ LC-MS protein expression across six human brain regions in Alzheimer’s disease vs controls (n=9/group; PRIDE e.g. PXD008739; HTTP-only) ([paper](https://doi.org/10.1038/s42003-018-0254-9)). `[GUI]`
...
- [GPMDB](https://gpmdb.thegpm.org/) - Global Proteome Machine Database of observed peptide and protein evidence from public tandem MS data reanalyzed with X!Tandem; US IP addresses have been blocked from queries since February 2025 (VPN/non-US access may be required).
...
- [Human Proteoform Atlas](https://human-proteoform-atlas.org/) - Provides experimentally verified human proteoforms, descended from the Consortium for Top-Down Proteomics Proteoform Atlas (SSL cert mismatch on `*.azurewebsites.net` as of 2026).
...
- [PPDB](http://ppdb.tc.cornell.edu/) - Curated Plant Proteome DataBase for Arabidopsis and maize with MS identifications, spectral counts, PTMs, and subcellular annotations (HTTP-only) ([paper](https://doi.org/10.1093/nar/gkn654)). `[GUI]`
...
- [CPPA](http://cppa.site/cppa/) - Interactive atlas of CPTAC MS proteomes and phosphoproteomes across ~13 cancer types / ~1.5k patients (DE, survival, stage, site-level phospho; site returns 404 and HTTPS cert expired Jun 2025 as of 2026) ([paper](https://doi.org/10.1021/acs.jproteome.2c00512)). `[GUI]`
...
- [Colorectal Cancer Atlas](https://www.coloncanceratlas.org/) - Integrated CRC genomic/proteomic atlas with reanalyzed label-free MS expression (~62k protein IDs / >8.3M MS/MS across tissues and cell lines; paper cites `colonatlas.org`) ([paper](https://doi.org/10.1093/nar/gkv1097)). `[GUI]`
- [Human Blood Proteomics Atlas (HuBP)](https://protein-notebook.streamlit.app/) - Streamlit atlas of MS blood/plasma protein detectability, intensity, and reproducibility across sample-prep methods (~12k proteins; Community Cloud login gate as of 2026) ([preprint](https://doi.org/10.1101/2025.05.15.654311)). `[GUI]` 🧪
...
- [MatrisomeDB](https://matrisomedb.org/) - Curated MS knowledge base of extracellular-matrix (matrisome) proteins across healthy and diseased human/mouse tissues, with peptide/PTM coverage maps (v2.0; 502 Bad Gateway as of 2026) ([paper](https://doi.org/10.1093/nar/gkac1009)). `[GUI]`
...
- [SubCellBarCode](https://subcellbarcode.org/) - MS fractionation resource and workflow mapping subcellular localization for ~12,400 genes across five cell lines, with a Bioconductor analysis package (README links SciLifeLab docs hub; interactive portal at subcellbarcode.org). `[API]`
...
- [YeastRGB](http://yeast-rgb.levy.mocel.unige.ch/) - Cell-grid browser comparing yeast protein abundance and localization across classic GFP and SWAT fluorescent libraries (HTTPS cert mismatch as of 2026) ([paper](https://doi.org/10.1093/nar/gky941)). `[GUI]`
...
- [SEPDB](https://sysomics.com/SEPDB/) - Secreted-protein knowledge base integrating human/mouse/rat secretory proteomics from serum, exosomes, and culture media with localization and disease annotations (TLS cert expired Jun 2025 as of 2026) ([paper](https://doi.org/10.1093/database/baae007)).
- [RiceProteomeDB (RPDB)](http://riceproteome.plantprofile.net/) - Web portal for storing, retrieving, and analyzing rice MS proteomics datasets (MaxQuant-oriented; host timeout as of 2026—Docker self-host on [GitHub](https://github.com/dongu7610/Riceproteome)) ([paper](https://doi.org/10.1038/s41598-024-54151-4)).
...
- [OmicsAnalyst](https://omicsanalyst.ca/) - Web platform for statistical, visual, and network-based integration of multiple omics datasets.
- [PaintOmics AI (PaintOmics 4)](https://paintomics.uv.es/) - Web/pathway painter for multi-omics (incl. proteomics) on KEGG, Reactome, and MapMan with metabolite hub/class and regulatory-omics modules (live site rebranded PaintOmics AI; [paper](https://doi.org/10.1093/nar/gkac352); [GitHub](https://github.com/ConesaLab/paintomics4)). `[GUI]`
...
- [iNetModels 2.0](https://inetmodels.com/) - Interactive multi-omics biological network DB (plasma proteomics with clinical/metabolome/microbiome MOBNs plus tissue/cancer GCNs; TLS cert expired, static build from Oct 2022) ([paper](https://doi.org/10.1093/nar/gkab254)). `[GUI]` `[API]`
...
- [pGWAS bibliography (metabolomix)](https://www.metabolomix.com/a-table-of-all-published-gwas-with-proteomics/) - Curated living table of published blood proteomics GWAS / pQTL studies (affinity and MS; updated ~2025-03; site returns WordPress error as of 2026-08) ([review](https://doi.org/10.1038/s41576-020-0268-2)).
...
- [Unipept](https://unipept.ugent.be/) - Web application, API, and CLI for taxonomic and functional analysis of metaproteomics peptides; v6.5.3 adds fast missed-cleavage / semi- and non-tryptic matching ([paper](https://doi.org/10.1021/acs.jproteome.4c00848)). `[GUI]` `[CLI]` `[API]`
...
- [pepFunk](https://github.com/northomics/pepFunk) - Peptide-centric KEGG functional enrichment (GSVA-style) for human gut metaproteomes; run locally or via [hosted Shiny](https://shiny2.imetalab.ca/shiny/rstudio/pepFunk/) ([paper](https://doi.org/10.1093/bioinformatics/btaa289)). `[GUI]`
...
- [MetaLab](https://imetalab.ca/) - Automated platform for metaproteomic identification, quantification, and taxonomic and functional annotation, supporting DDA and DIA data (discontinued at U Ottawa; successor [MetaPilot](https://metapilot.metaproteomicshub.org/)). `[GUI]` 🪟
- [MetaLab-MAG](https://imetalab.ca/) - MetaLab module for genome-level metaproteomics against MAG databases (e.g. UHGG) with LFQ and isobaric quant; shares MetaLab desktop download URL ([paper](https://doi.org/10.1021/acs.jproteome.2c00554); successor [MetaPilot](https://metapilot.metaproteomicshub.org/)). `[GUI]` 🪟
...
- [iMPI](https://impi.omicsbio.info/) - Database of intron-retention microproteins in human tumors with large-scale proteomic MS validation across 27 cancer types (TLS cert expired 2026-06-27) ([paper](https://doi.org/10.1002/pmic.70142)).
...
- [PgxSAVy](https://github.com/anuragraj/PgxSAVy) - Quality control and annotation of proteogenomic variant peptides after FDR (Variant Ambiguity Score; isobaric and positional-decoy checks); hosted web server at [pgxsavy.igib.res.in](https://pgxsavy.igib.res.in/) returned connection timeouts as of 2026-08 (GitHub CLI still available) ([paper](https://doi.org/10.1016/j.csbj.2023.12.033)). `[CLI]`
...
- [Spritz](https://smith-chem-wisc.github.io/Spritz/) - Builds sample-specific proteoform search databases with sequence variants and UniProt/MetaMorpheus PTMs from RNA-seq (**0.3.14**; Windows GUI + CLI) ([paper](https://doi.org/10.1021/acs.jproteome.0c00407)). `[GUI]` `[CLI]` 🪟
...
- [PPLine](https://sourceforge.net/projects/ppline/) - Python pipeline for SAP/indel/splice-variant discovery from RNA-seq/exome for proteogenomics (C-HPP-era; last SourceForge release 2018) ([paper](https://doi.org/10.1021/acs.jproteome.5b00490)). `[CLI]`

### Other Emerging Approaches

> Immunopeptidomics and interaction (AP-MS) proteomics.

- [MHCquant](https://nf-co.re/mhcquant/) - Nextflow/nf-core pipeline for identifying and quantifying MHC-presented (immunopeptidomics) peptides, built on OpenMS ([paper](https://doi.org/10.1021/acs.jproteome.9b00313)). `[CLI]` 📦
...
- [PAMPA](https://github.com/touzet/pampa) - ZooMS/paleoproteomics suite for taxonomic identification from MALDI peptide mass fingerprints using collagen marker tables ([paper](https://doi.org/10.1021/acs.jproteome.5c00389)). `[CLI]`
...
- [WeSA](https://github.com/russelllab/wesa) - Weighted SocioAffinity scoring/ranking for affinity proteomics bait–prey lists (AP-MS, IP, proximity labeling) with interactive network filtering ([web](https://wesa.russelllab.org/); [paper](https://doi.org/10.1093/nar/gkae423)). `[GUI]` `[CLI]`
...
- [SafeQuant](https://github.com/eahrne/SafeQuant) - Archived R toolbox for Progenesis LFQ / Scaffold TMT post-processing (last CRAN 2.3.1, 2016; removed from CRAN 2020); prefer [MSstats](#statistical-analysis) or [proteoDA](#statistical-analysis) ([paper](https://doi.org/10.1021/acs.jproteome.6b00066)). `[TMT]` `[Label-Free]` `[CLI]`
...
- [synapter](https://github.com/lgatto/synapter) - Archived Bioconductor pipeline combining Waters Synapt MSe/HDMSe identification and quantitation runs (JPR 2013); removed from Bioconductor 3.20+, GitHub archived—prefer vendor PLGS/Progenesis or modern DIA stacks ([paper](https://doi.org/10.1021/pr300776t)). `[Label-Free]` `[CLI]`
- [proteoQC](https://github.com/wenbostar/proteoQC) - Removed Bioconductor HTML QC reporter for MS/MS searches (last Bioc ~3.11 / 2020); prefer [PTXQC](#quality-control). `[CLI]`
- [DIP (Database of Interacting Proteins)](https://dip.doe-mbi.ucla.edu/dip/Main.cgi) - Classic UCLA curated experimental PPI catalog (site live; curation frozen ~2020)—prefer [IntAct](#pathways--interactions) for actively curated IMEx data ([paper](https://doi.org/10.1093/nar/30.1.303)).
...
- [CCMS (UCSD)](https://massive.ucsd.edu/) - Center for Computational Mass Spectrometry software ecosystem (MS-GF+, MSPLIT/MSPLIT-DIA, MixGF, and related tools; software hub page empty as of 2026-08) ([GitHub](https://github.com/CCMS-UCSD)).
...
- [Guo Lab (guomics)](https://github.com/guomics-lab) - Tiannan Guo group tools and resources spanning DIA workflows, clinical proteomics, and data portals ([guomics.com](https://guomics.com/)).
- [Gygi Lab](https://gygi.hms.harvard.edu/software.html) - Harvard software portal (AScore, Real-Time Search / Tomahto / GoDig, PIXL, BioPlex Explorer, Monocle, and related utilities).
...
- [Statistical Biotechnology (Käll Lab)](https://github.com/statisticalbiotechnology) - KTH group behind Percolator, triqler, diffacto, quandenser, and related identification/quant statistics ([Percolator](https://github.com/percolator/percolator)).
- [Vitek Lab](https://github.com/Vitek-Lab) - MSstats ecosystem for quantitative proteomics statistics (MSstats, MSstatsTMT, and related packages) ([msstats.org](https://msstats.org/)).
...
Three tracks: **list entries** (tools, resources), **mini-guides** (500-word focused comparisons), and **full guides or workflows** (opinionated deep-dives or step-by-step pipelines).

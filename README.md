...
- [EBprotV2](https://github.com/cssblab/EBprot) - Perseus plugin for peptide-ratio-based differential abundance in labeling (and ratio-transformed LFQ) experiments using a semiparametric mixture model ([paper](https://doi.org/10.1021/acs.jproteome.8b00483)). `[GUI]` 🪟
...
- [OrthoDB](https://www.orthodb.org/) - Hierarchical catalog of orthologs across eukaryotes, prokaryotes, and viruses with evolutionary/functional annotations (v12.2; ~165M genes) ([paper](https://doi.org/10.1093/nar/gkae987)). `[GUI]` `[API]`
